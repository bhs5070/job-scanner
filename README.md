...
| 메트릭 | 점수 | 설명 |
|--------|------|------|
| Relevance | 0.750 | 질문-답변 관련성 |
| Groundedness | 0.750 | 검색 데이터에 근거한 답변 |
| Helpfulness | 0.725 | 취업 준비생에게 실용적 도움 |
| Faithfulness | 0.750 | Hallucination 없음 |
| Answer Completeness | 0.750 | 질문의 모든 부분에 답변 |
| Retrieval Precision | 0.750 | 검색된 공고의 관련성 |
| Retrieval MRR | 0.775 | 가장 관련 있는 결과의 순위 |
| Context Relevance | 0.775 | 검색 컨텍스트 적합성 |
| Routing Accuracy | 0.700 | 의도 분류 정확도 |
| **평균** | **0.747** | |
